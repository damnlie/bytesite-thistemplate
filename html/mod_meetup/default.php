...
<?php else : ?>
	...
	<?php /* <div style="display:none"><?php var_dump($event); ?></div> */ ?>
	<div class="panel panel-secondary" itemscope itemtype="http://data-vocabulary.org/Event">
		<div class="panel-heading">
			...
			<h3 class="inline color-inherit">
				<?php if ($params->get('showEventLink') == 'title') : ?>
					<a href="<?php echo $event->url ?>" itemprop="url" target="_blank" class="color-inherit"><span itemprop="summary"><?php echo $event->name; ?></span></a>
				<?php else : ?>
			...
			<div class="col-sm-4">
				<div>
					...
					<div class="rsvp-callout-outer">
						<a href="<?php echo $event->url; ?>" class="btn btn-primary btn-block rsvp-callout-rsvp" target="_blank"><?php echo JText::_('MOD_MEETUP_RSVP'); ?></a>
					</div>
				</div>
			</div>
		</div>
